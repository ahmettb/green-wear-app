...
public class ProductController {
    ...
    @CrossOrigin
    public ResponseEntity<List<ProductResponse>> getProductByCategory(@RequestParam("ids")List<Long>ids) {
                    return new ResponseEntity<>(productService.getProductByCategory(ids), HttpStatus.OK);
