...
//        product.setSizeS(request.getSizeS());
    ...
    public static ProductResponse mapToResponse(Product product) {
        ...
        response.setMaterial(product.getType().getDisplayName());
        ...
        response.setEnergyUsage(product.getEnvironmentalImpact().getEnergy());
     ...
     //   response.setSizeM(product.getMSizeCount());
      ...
      //  response.setSizeXL(product.getXlSizeCount());
        ...
        response.setRecyclabilityScore(product.getPoint());
